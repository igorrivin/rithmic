...
_LASTTRADE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ssboe', full_name='rti.LastTrade.ssboe', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='usecs', full_name='rti.LastTrade.usecs', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='source_ssboe', full_name='rti.LastTrade.source_ssboe', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='source_usecs', full_name='rti.LastTrade.source_usecs', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='source_nsecs', full_name='rti.LastTrade.source_nsecs', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='jop_ssboe', full_name='rti.LastTrade.jop_ssboe', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='jop_nsecs', full_name='rti.LastTrade.jop_nsecs', index=21,
