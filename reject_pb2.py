...
_REJECT = _descriptor.Descriptor(
  name='Reject',
  full_name='rti.Reject',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='template_id', full_name='rti.Reject.template_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='user_msg', full_name='rti.Reject.user_msg', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rp_code', full_name='rti.Reject.rp_code', index=2,
...
Reject = _reflection.GeneratedProtocolMessageType('Reject', (_message.Message,), dict(
  DESCRIPTOR = _REJECT,
  __module__ = 'reject_pb2'
  # @@protoc_insertion_point(class_scope:rti.Reject)
  ))
